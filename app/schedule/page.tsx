  ...
  return (
    <main className='w-full py-20' id="UpNextCard">
      ...
      <div
        ...
        style={{ backgroundImage: nextEvent.poster ? `url('${nextEvent.poster}')` : "url('/images/community_worship.jpg')" }}
      >
      ...
      <div className='max-w-5xl mx-auto -mt-16 relative z-20 px-4'>
        <div className='flex flex-col md:flex-row rounded-3xl overflow-hidden border shadow-2xl bg-card text-card-foreground'>
          ...
          <div className='flex flex-row items-center justify-center gap-3 md:flex-col md:justify-center md:items-center py-6 px-8 md:py-12 md:w-1/4 bg-primary text-primary-foreground font-bebas shrink-0'>
            ...
            <div className='text-5xl md:text-9xl font-bold leading-none'>{day}</div>
          ...
          <div className='p-6 sm:p-10 flex flex-col gap-6 flex-1'>
            ...
            <div className='text-sm sm:text-base text-muted-foreground leading-relaxed space-y-4'>
              {nextEvent.description ? (
                <div className="prose prose-invert max-w-none text-muted-foreground" dangerouslySetInnerHTML={{ __html: nextEvent.description.replace(/\n/g, '<br/>') }} />
              ) : (
                <p>Experience unbroken worship, deep intercession, and the raw presence of God. Join us as we press into the heart of the Father together.</p>
              )}
            </div>
            ...
            <div className='pt-6 border-t border-border/50 flex flex-col sm:flex-row sm:items-center gap-6 text-sm text-muted-foreground'>
              ...
              <div className='flex items-center gap-3'>
                ...
                <div>
                   ...
                   <p>{nextEvent.location || "Online / To Be Announced"}</p>
                </div>
              </div>
            </div>
      ...
      <div className='max-w-5xl mx-auto py-20 px-4'>
        <div className='rounded-3xl p-8 sm:p-12 bg-neutral-900 border border-white/10 text-center relative overflow-hidden'>
          ...
          <h2 className="text-3xl md:text-5xl font-bebas mb-4 text-white">Sustain the Fire</h2>
          <p className='text-neutral-400 mb-8 max-w-2xl mx-auto text-base sm:text-lg'>
             Every hour of worship is a collective sacrifice. Join our community of intercessors, worshippers, and builders.
          </p>
          <a
            href='/get-involved'
