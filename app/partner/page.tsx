  ...
  <div className="container py-24">
    <div className="relative h-[500px] flex-1">
      <div className="absolute inset-0 flex size-full items-center justify-center overflow-hidden rounded-xl object-cover">
        <img src="/images/placeholders/original/1600x1200-video.png" alt="video"
    ...
    <div className="grid grid-cols-2 gap-12 pt-12">
      ...
      <div>
        ...
        <div className="mt-8 flex justify-start gap-4">
          <button
            className="flex items-center rounded-xl bg-blue-600 px-5 py-3 text-center text-base font-medium text-white transition duration-500 ease-in-out hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 lg:px-6">Get
            Bundle</button>
          <button
            className="flex items-center rounded-xl border border-gray-600 px-5 py-3 text-center font-medium text-gray-600 transition duration-500 ease-in-out hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 lg:px-6">See
            Features<svg width="24" height="24" viewBox="0 0 24 24" className="ml-1 size-6">
